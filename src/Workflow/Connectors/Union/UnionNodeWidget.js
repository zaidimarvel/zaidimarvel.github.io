...
import {UnionPortLabel} from "./UnionPortLabelWidget";
import "./union-node.css";

export class UnionNodeWidget extends React.Component {
    static propTypes = {
        node: PropTypes.any,
    };
    ...
    generatePort(port) {
        return <UnionPortLabel model={port} key={port.id}/>;
    }
    createMarkup() {
        return <div>
